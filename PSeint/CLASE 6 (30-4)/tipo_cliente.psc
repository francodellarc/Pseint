...
Segun cliente Hacer
	1:		Imprimir "Su compra no obtiene ningún descuento, debe abonar el total de $", compra
		2: compra=compra*0.95;
			Imprimir "Su compra tiene un descuento del 5%! Debe abonar el total de $", compra
		3: compra=compra*0.90;
			Imprimir "Su compra tiene un descuento del 10%! Debe abonar el total de $", compra
FinSegun
